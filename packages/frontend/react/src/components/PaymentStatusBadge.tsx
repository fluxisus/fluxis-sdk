...
const STATUS_CONFIG: Record<CheckoutSession['status'], StatusConfig> = {
  pending: { background: 'rgba(37, 99, 235, 0.1)', color: '#1d4ed8', label: 'Pendiente de pago' },
  selecting_asset: { background: 'rgba(37, 99, 235, 0.1)', color: '#1d4ed8', label: 'Pendiente de pago' },
